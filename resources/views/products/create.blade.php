                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="quantity" name="quantity" value="{{ old('quantity') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            @error('quantity')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="manufacturing_price" name="manufacturing_price" value="{{ old('manufacturing_price') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="selling_price" name="selling_price" value="{{ old('selling_price') }}" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            @error('selling_price')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
